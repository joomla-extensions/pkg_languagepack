    ...
    <div class="items-row cols-1 row-0 row-fluid clearfix">
        <div class="span12">
            <div class="item column-1" itemprop="blogPost" itemscope="" itemtype="https://schema.org/BlogPosting">
                ...
                <?php if (!empty($language->coordinator_forum_id)) : ?><p><?php echo Text::sprintf('COM_LANGUAGE_PACK_APPLICATION_TEAM_COORDINATOR', '<a href="https://forum.joomla.org/memberlist.php?mode=viewprofile&u=' . $language->coordinator_forum_id . '">' . $language->coordinator . '</a>') ?></p><?php endif; ?>
