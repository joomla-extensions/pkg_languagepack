...
<div class="languages">
    ...
    <form action="<?php echo Route::_('index.php?option=com_languagepack&lang=' . $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
