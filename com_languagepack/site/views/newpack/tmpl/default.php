...
<div class="languages">
    ...
    <form action="<?php echo Route::_('index.php?option=com_languagepack&id=' . (int) $this->item->id . '&lang=' . $this->langId); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
